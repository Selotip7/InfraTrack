  ...
  return (
    <>
      <div className=" w-full flex justify-between px-3 h-16  items-center font-sans ">
        ...
        <div id="right-item" className="flex items-center gap-3 ">
          <button
            id="notification"
          ...
          <div
            id="date"
            className=" min-w-20 h-8 px-1  bg-white drop-shadow-gray-400  rounded-md shadow-[0_0_3px_2px_rgba(0,0,0,0.1)] flex justify-center items-center   "
          >
